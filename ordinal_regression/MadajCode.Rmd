...
toc: yes
toc_float: yes
# EJC 4/5/21: I modified the original code by Zachary Madaj at VAI so it would run on my system and run as an R markdown file
---
...
# Read in dataset
data = read.table("/Users/Eli/Dropbox/Neurodegeneration/TauSpread/LRRK2 Tau Manuscript/031721_TotalTauPath_Subset.csv",sep=",",header=T)
