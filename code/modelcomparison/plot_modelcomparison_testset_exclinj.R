...
load(file = paste(savedir,grp,'CNDRSpaceModelComparison_TrainTest_ExcludeInjectionSites.RData',sep=''))
...
ggsave(p,filename = paste(savedir,grp,'ModelComparisonTestSetPearsonR_CNDRSpace_ExcludeInjectionSites.pdf',sep=''),
...
ggsave(p.all,filename = paste(savedir,grp,'ModelComparisonTestSetPearsonR_Matrix_CNDRSpace_ExcludeInjectionSites.pdf',sep=''),
...
write.csv(x=p.stat.mat,file = paste0(savedir,grp,'PValsModelComparisonTestSet_ExcludeInjectionSites.csv'))
